...
const ReviewerTopRated = () => {
  ...
  const fetchImages = async () => {
    try {
      const response = await fetch('http://127.0.0.1:8000/api/movies/reviewersfavs');
  ...
  return (
    <div className="movie-slider">
      ...
      <div className="slidertitle-strip">
        <h2 className="slidertitle">Reviewers Favourites</h2>
      </div>
...
export default ReviewerTopRated;
