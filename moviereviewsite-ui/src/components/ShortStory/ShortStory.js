...
const ShortStory = () => {
    ...
    return (
        <div>
            <HeaderHome />
        <div className='StortStory-body'>
            
            <div className="StoryStoryImage"></div>
            {/* <div className="woolf"></div> */}

            <div className="ShortStory-content-container" style={{ background: 'url("https://d2j6dbq0eux0bg.cloudfront.net/images/11503874/611438038.jpg")' }}>
                <div className="shortstory-content">
