...
const FromThisWeek = () => {
  ...
  const fetchImages = async () => {
    try {
      const response = await fetch('http://127.0.0.1:8000/api/movies/latest');
      console.log("Latest api calling")
  ...
  return (
    <div className="movie-slider">
      ...
      <div className="slidertitle-strip">
        <h2 className="slidertitle">Latest</h2>
      </div>
